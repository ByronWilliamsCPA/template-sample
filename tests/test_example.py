"""Example tests demonstrating best practices for Template Sample.
...
class TestPackageInitialization:
    ...
    def test_package_author_exists(self) -> None:
        ...
        """
        from template_sample import __author__, __email__
...
class TestLogging:
    ...
    def test_get_logger_returns_logger(self) -> None:
        ...
        """
        from template_sample.utils.logging import get_logger
    ...
    def test_log_performance(self) -> None:
        ...
        from template_sample.utils.logging import log_performance
...
class TestCLI:
    ...
    def test_cli_has_version(self) -> None:
        ...
        """
        from template_sample.cli import cli
    ...
    def test_cli_config_command(self) -> None:
        ...
        assert "Project: Template Sample" in result.output
    ...
    def test_cli_context_setup(self) -> None:
        ...
        assert result.exit_code == 0
        assert "Template Sample" in result.output
    ...
    def test_cli_hello_error_handling(self) -> None:
        ...
        with patch("template_sample.cli.logger") as mock_logger:
...
class TestLoggingJSON:
    ...
    def test_json_logging_renderer(self) -> None:
        ...
        """
        from template_sample.utils.logging import setup_logging
...
class TestExampleIntegration:
    ...
    def test_package_imports(self) -> None:
        ...
        import template_sample

        assert hasattr(template_sample, "__version__")

        # Test importing from submodules
        from template_sample.utils import get_logger

        assert callable(get_logger)

        from template_sample.core import Settings
