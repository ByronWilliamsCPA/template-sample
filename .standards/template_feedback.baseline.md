...
- `template_sample/path/to/file.ext`
...
`template_sample/.github/workflows/`.

**Affected Files**:
- `template_sample/.github/workflows/ci.yml`
- `template_sample/.github/workflows/release.yml`
- `template_sample/.github/workflows/docs.yml`
