...
git remote add origin https://github.com/ByronWilliamsCPA/template-sample.git
...
3. **Enter your repository URL**: `https://github.com/ByronWilliamsCPA/template_sample`
...
3. **Get your project key**: Should be `ByronWilliamsCPA_template_sample`
...
2. **Security Contact**: Change `security@byronwilliamscpa.com` if needed
