"""Command-line interface for Template Sample.
...
@click.group()
@click.version_option(version="0.1.0", prog_name="template_sample")
@click.option(
    "--debug",
    is_flag=True,
...
def cli(ctx: click.Context, debug: bool) -> None:
    """Template Sample - A comprehensive test project with all template features enabled."""
...
def config(ctx: click.Context) -> None:
    ...
    try:
        ...
        click.echo("  Project: Template Sample")
