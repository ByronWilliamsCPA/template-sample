...
Setup:
    ...
    3. Initialize in your application:
       from template_sample.core.sentry import init_sentry
       init_sentry()
"""
...
def _get_release_version() -> str:
    ...
    try:
        ...
        pkg_version = version("template-sample")
        return f"template_sample@{pkg_version}"
    except Exception:
        pass

    # Ultimate fallback
    return "template_sample@0.1.0"
